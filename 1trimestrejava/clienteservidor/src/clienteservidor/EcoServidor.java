	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			while (true) {
				...
				// Lo muestra en la consola del servidor
				String inver = responderComoUnServidorWeb();
				System.out.println("Cliente: " + inver);
				// Envia la respuesta la cliente
				conexionSalida.println(">>" + inver);
				if (str == null || str.equals("Adios"))
					break;
			}
